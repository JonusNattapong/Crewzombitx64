...
- [Overview](#overview)
- [📦 Releases](#-releases)
  - [Version 1.4.0 (Latest)](#version-140-latest)
...
-   **Dark Mode Enhancements**:
    -   Created dark mode versions for all main scripts:
        -   `CrewAPIDarkX64.py`: API version with dark mode
        -   `CrewNormalDarkX64.py`: Local version with dark mode
        -   `CrewColabDarkX64.ipynb`: Colab version with dark mode
    -   Added enhanced warnings and disclaimers in both English and Thai
